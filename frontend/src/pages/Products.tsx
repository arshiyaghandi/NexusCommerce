...
export default function Products() {
  ...
  return (
    <div className="animate-fade-in-up" style={{ display: 'flex', gap: '2rem', alignItems: 'flex-start' }}>
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
          ...
          <form onSubmit={handleSearchSubmit} style={{ display: 'flex', gap: '0.5rem', width: '280px' }}>
            ...
            {products?.map((product) => (
              <div key={product.id} className="glass glass-card" style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column' }}>
                ...
                <div className="flex-between" style={{ marginTop: 'auto' }}>
                  ...
                  <button className="btn btn-primary" onClick={() => handleAddToCart(product)} style={{ fontSize: '0.85rem', padding: '0.45rem 0.9rem' }}>
